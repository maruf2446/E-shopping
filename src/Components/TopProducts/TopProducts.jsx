...
import Img1 from "../../assets/img/hero/11.jpg"
import Img2 from "../../assets/img/hero/5.jpg"
import Img3 from "../../assets/img/hero/10.jpg"
        ...
        <div>
            <div className='container'>
                ...
                <div className='text-left mb-24'>
                    ...
                    <p data-aos="fade-up" className='text-xs text-gray-400'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Amet, nemo.</p>
                </div>
                {/* Body section  */}
                        ...
                        ProductsData.map((data) => (
                            <div className='rounded-2xl bg-white dark:bg-gray-800 hover:bg-black/80 dark:hover:bg-primary hover:text-white relative shadow-xl duration-300 group max-w-[300px]'>
                                ...
                                <div className='p-4 text-center'>
                                    ...
                                    <button className='bg-primary hover:scale-105 duration-300 text-white py-1 px-4 rounded-full mt-4 group-hover:bg-white group-hover:text-black'>
                                        Order Now
                                    </button>
                                </div>
                            </div>
